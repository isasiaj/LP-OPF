...
while !finPrograma
    ...
    #if opfTipo == "LP-OPF"
    m, solGen, solFlujos, solAngulos, solLMP = LP_OPF(datos[1], datos[2], datos[3], datos[4], datos[5], datos[6], s)
    ...
    gestorResultados(m, solGen, solFlujos, solAngulos, solLMP, datos[7], s)
