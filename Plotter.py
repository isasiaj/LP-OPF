...
# Fijar la normalización de los pesos en el rango [0, 1]
...
for (u, v, d) in G.edges(data=True):
    ...
    nx.draw_networkx_edges(G, pos, edgelist=[(u, v)], width=3, alpha=0.8, edge_color=[edge_color], ax=ax, style='solid')
